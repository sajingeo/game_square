...
volatile bool rainbow_mode = false;
...
//define a callback for key presses
TrellisCallback rainbow(keyEvent evt){
  if(evt.bit.EDGE == SEESAW_KEYPAD_EDGE_RISING)
...
void setup() {
  ...
  // start rainbow!
  trellis.activateKey(0, 0, SEESAW_KEYPAD_EDGE_RISING, true);
  trellis.activateKey(0, 0, SEESAW_KEYPAD_EDGE_FALLING, true);
  trellis.registerCallback(0, 0, rainbow);
